...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Chế iu uiiiiii x " + (thePercent+420) +"💓 ";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp; Em cute quóoooooo:';
document.querySelector('.Description .modal-body').innerHTML = 'Cho chị xin 1 slot vào tim iem được khumm 😚😽<i class="fas fa-heart"></i> ';
